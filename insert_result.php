                    ...
                    if(mysqli_num_rows($already_result)>0){
                      ...
                      if($marks>100){
                        echo"<p style='color:red;font-weight:bold;text-align:center;margin-bottom:20px;''>Input Marks is grater then Limit.</p>";
                            ...
                            echo"<p style='color:green;font-weight:bold;text-align:center;margin-bottom:20px;''>Marks Inserted! <br> </p>"; 
                            echo" <p style='color:green;font-weight:bold;text-align:center;margin-bottom:20px;''> Input mark is $marks <br></p>";
